  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-4 pt-2">
        ...
        {success && (
          <p className="text-sm text-green-700 dark:text-green-400">Round 3 picks saved!</p>
        )}
      </div>
    </form>
  );
...
function Column({
  ...
  return (
    <section className="space-y-4">
      ...
      {matchups.length === 0 ? (
        <p className="text-sm italic text-gray-500">No conference final matchups configured.</p>
      ) : (
